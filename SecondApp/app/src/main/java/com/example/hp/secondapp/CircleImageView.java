 ...
 */
package com.example.hp.circleimageview;
...
import com.example.hp.secondapp.R;
...
public class CircleImageView extends ImageView {
    ...
    private void setup() {
        ...
        mBitmapPaint.setShader(mBitmapShader);  //设置图片画笔渲染器

        mBorderPaint.setStyle(Paint.Style.STROKE);  //设置边界画笔样式
