...
import com.example.a14512.audiovediodemo.wechat.widget.SendView;
import com.example.a14512.audiovediodemo.wechat.widget.VideoProgressBar;
...
//        view = (TextView) findViewById(R.id.view);
        ...
        send.mBackLayout.setOnClickListener(backClick);
        send.mSelectLayout.setOnClickListener(selectClick);
                        ...
                        case MotionEvent.ACTION_UP:
                            if (!isCancel) {
                                ...
                                if (mProgress < 10) {
                                    ...
                                    Toast.makeText(VideoActivity.this, "时间太短", Toast.LENGTH_SHORT).show();
                                    stopView(false);
                                    break;
                                }
                                //停止录制
                                ...
                                //现在是取消状态,不保存
                                mediaUtils.stopRecordUnSave();
                                Toast.makeText(VideoActivity.this, "取消保存", Toast.LENGTH_SHORT).show();
                                stopView(false);
                            }
                            ret = false;
                            break;
    ...
    private View.OnClickListener selectClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(VideoActivity.this, "文件以保存至：" + path, Toast.LENGTH_SHORT).show();
            send.stopAnim();
            recordLayout.setVisibility(View.VISIBLE);
        }
    };
