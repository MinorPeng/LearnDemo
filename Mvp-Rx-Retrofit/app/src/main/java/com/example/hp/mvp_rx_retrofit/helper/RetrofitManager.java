package com.example.hp.mvp_rx_retrofit.helper;

import com.example.hp.mvp_rx_retrofit.api.ApiUrl;
import com.example.hp.mvp_rx_retrofit.MyApplication;
import com.example.hp.mvp_rx_retrofit.api.WeatherServiceApi;
import com.example.hp.mvp_rx_retrofit.utils.NetUtil;
        ...
        if (mOkHttpClient == null) {
            synchronized (RetrofitManager.class) {
                if (mOkHttpClient == null) {
                    ...
                    // 指定缓存路径,缓存大小100Mb
                    Cache cache = new Cache(new File(MyApplication
                            .getContext()
