...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        msgsRecyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL));
        //下拉刷新
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(getActivity(), "更新了三条数据...", Toast.LENGTH_SHORT).show();
                    }
                },500);
            }
        });
        ...
        msgsRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == recyclerView.SCROLL_STATE_IDLE && lastVisibleItem + 1 == mMessagesAdapter.getItemCount()) {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            initMsgs(2);  //把要加载的实例化
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Frag1_SecondActivity.actionStart(getActivity(), news.getName());
                }
            });
            return holder;
        }
